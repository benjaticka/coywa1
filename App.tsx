      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
          <div className="max-w-md w-full bg-white rounded-xl shadow-xl p-8 border border-red-100">
            ...
            <p className="text-slate-600 mb-6">The application encountered an unexpected error. Please check the console for details.</p>
            <pre className="bg-slate-100 p-4 rounded text-xs overflow-auto max-h-40 mb-6 font-mono">
